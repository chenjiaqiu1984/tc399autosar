...
#if (  (PDUR_SW_MAJOR_VERSION != (15u)) \
    || (PDUR_SW_MINOR_VERSION != (4u)) \
    || (PDUR_SW_PATCH_VERSION != (1u)) )
 ...
 *  \synchronous TRUE
 ********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_InitMemorySection(PduR_MemIdxType memIdx);
 ...
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_Init_RmDestRpgRom(PduR_MemIdxType memIdx);
#endif
 ...
 *              by other administrative function calls.
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_Rm_MultipleSourceHandler_Init(PduR_MemIdxType memIdx);
#endif
 ...
 *  \pre        -
 ********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_EvC_Init(PduR_MemIdxType memIdx);
#endif
 ...
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_EvC_ReadFlush(PduR_DeferredEventCacheRomIdxOfSrcApplicationRomType deferredEventCacheIdx, PduR_MemIdxType memIdx);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(PduR_DeferredEventCacheArrayRamReadIdxOfDeferredEventCacheRamType, PDUR_CODE) PduR_EvC_GetDeferredEventCacheArrayRamReadIdxSafe(PduR_DeferredEventCacheRomIdxOfSrcApplicationRomType deferredEventCacheIdx, PduR_MemIdxType memIdx);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(PduR_DeferredEventCacheArrayRamWriteIdxOfDeferredEventCacheRamType, PDUR_CODE) PduR_EvC_GetDeferredEventCacheArrayRamWriteIdxSafe(PduR_DeferredEventCacheRomIdxOfSrcApplicationRomType deferredEventCacheIdx, PduR_MemIdxType memIdx);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(boolean, PDUR_CODE) PduR_EvC_IsFull(PduR_DeferredEventCacheRomIdxOfSrcApplicationRomType deferredEventCacheIdx, PduR_MemIdxType memIdx);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(boolean, PDUR_CODE) PduR_EvC_IsAnyEvCOverflowed(PduR_DestApplicationManagerRomIterType destApplicationManagerRomIdx);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_EvC_FlushAllEvCOfDestApplication(PduR_DestApplicationManagerRomIterType destApplicationManagerRomIdx);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_EvC_ReadAndProcessEvCOfDestApplication(PduR_DestApplicationManagerRomIterType destApplicationManagerRomIdx);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_ProcessAllDestinationsOfDestApplication(PduR_DestApplicationManagerRomIterType destApplicationManagerRomIdx);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(boolean, PDUR_CODE) PduR_IsRmGDestIdxValidOnApplication(PduR_RmGDestRomIterType rmGDestRomIdx, PduR_DestApplicationManagerRomIterType applicationId);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_CreatePartitionLookupTable(void);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(PduR_MemIdxType, PDUR_CODE) PduR_GetMemorySectionIndexOfOsApplication(ApplicationType applicationId);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(PduR_MemIdxType, PDUR_CODE) PduR_GetMemIdx(void);
...
# if (PDUR_MCQBUFFERROM == STD_ON)
      ...
      PduR_McQ_MainFunction((PduR_DestApplicationManagerRomIdxOfMmRomType) destApplicationManagerRomIdx);
# endif
    }
  }
...
FUNC(void, PDUR_CODE) PduR_EvC_WriteDeferredEventCache(PduR_RmDestRomIterType rmDest, PduR_RmGDestRomIdxOfRmDestRomType rmGDest)
{
  ...
  PduR_DestApplicationManagerRomIdxOfMmRomType srcApplicationIdx  = PduR_GetDestApplicationManagerRomIdxOfMmRom(PduR_GetMmRomIdxOfRmSrcRom(PduR_GetRmSrcRomIdxOfRmDestRom(rmDest)));
  PduR_DestApplicationManagerRomIdxOfMmRomType destApplicationIdx = PduR_GetDestApplicationManagerRomIdxOfMmRom(PduR_GetMmRomIdxOfRmGDestRom(rmGDest));
...
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_ProcessAllDestinationsOfDestApplication(PduR_DestApplicationManagerRomIterType destApplicationManagerRomIdx)
{
  ...
  for(mmIndIdx = PduR_GetMmRomIndStartIdxOfDestApplicationManagerRom(destApplicationManagerRomIdx); mmIndIdx < PduR_GetMmRomIndEndIdxOfDestApplicationManagerRom(destApplicationManagerRomIdx); mmIndIdx++)
  {
    PduR_RmGDestRomIterType rmGDestRomIdx;
...
LOCAL_INLINE FUNC(boolean, PDUR_CODE) PduR_IsRmGDestIdxValidOnApplication(PduR_RmGDestRomIterType rmGDestRomIdx, PduR_DestApplicationManagerRomIterType applicationId)
{
  ...
  PduR_DestApplicationManagerRomIterType supposedApplicationId = PduR_GetDestApplicationManagerRomIdxOfMmRom(PduR_GetMmRomIdxOfRmGDestRom(rmGDestRomIdx));
