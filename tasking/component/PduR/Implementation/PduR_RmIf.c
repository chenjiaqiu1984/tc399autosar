 ...
 *  \pre        -
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(PduLengthType, PDUR_CODE) PduR_RmIf_TruncateDlc(PduR_RmGDestRomIterType rmGDest, P2CONST(PduInfoType, AUTOMATIC, PDUR_APPL_DATA) info);
#endif
 ...
 *  \synchronous TRUE
**********************************************************************************************************************/
LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE) PduR_RmIf_CheckInfoPointer(P2CONST(PduInfoType, AUTOMATIC, PDUR_APPL_DATA) info, uint8 apiId);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(PduR_ActualLengthOfSingleBufferRamType, PDUR_CODE) PduR_RmIf_GetActualLengthOfSingleBufferRamSafe(PduR_SingleBufferRomIdxOfRmBufferedIfPropertiesRomType singleBufferRomIdx, PduR_MemIdxType memIdx);
#endif
...
#   endif
            {
              ...
              PduR_DestApplicationManagerRomIdxOfMmRomType destApplicationIdx = PduR_GetDestApplicationManagerRomIdxOfMmRom(PduR_GetMmRomIdxOfRmSrcRom(PduR_GetRmSrcRomIdxOfRmDestRom(rmDestRomIdx)));
              PduR_DestApplicationManagerRomIdxOfMmRomType srcApplicationIdx = PduR_GetDestApplicationManagerRomIdxOfMmRom(PduR_GetMmRomIdxOfRmGDestRom(rmGDestRomIdx));
...
FUNC(Std_ReturnType, PDUR_CODE) PduR_RmIf_SingleBuffer_Put(PduR_RmGDestRomIterType rmGDestRomIdx, PduR_RmDestRomIterType rmDestRomIdx, PduLengthType pduLength, SduDataPtrType sduDataPtr)  /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
{
  ...
  PduR_Core_MemCpyRamToRam(PduR_GetAddrSingleBufferArrayRam(PduR_GetSingleBufferArrayRamStartIdxOfSingleBufferRom(singleBufferRomIdx, memIdx), memIdx), sduDataPtr, pduLength);   /* PRQA S 0315, 3673 */ /* MD_MSR_VStdLibCopy, MD_MSR_Rule8.13 */ /* SBSW_PDUR_MEM_CPY_FIFOMGR */
...
# if (PDUR_EXTENDED_ERROR_CHECKS == STD_ON)
  ...
  {
    actualLengthOfSingleBuffer = singleBufferArrayLength;
...
# if (PDUR_MCQBUFFERROM == STD_ON)
          PduR_DestApplicationManagerRomIdxOfMmRomType destApplicationIdx = PduR_GetDestApplicationManagerRomIdxOfMmRom(PduR_GetMmRomIdxOfRmGDestRom(PduR_GetRmGDestRomIdxOfRmDestRom(rmDestIdx)));
          PduR_DestApplicationManagerRomIdxOfMmRomType srcApplicationIdx = PduR_GetDestApplicationManagerRomIdxOfMmRom(PduR_GetMmRomIdxOfRmSrcRom(PduR_GetRmSrcRomIdxOfRmDestRom(rmDestIdx)));
