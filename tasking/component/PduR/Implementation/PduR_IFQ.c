 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(PduR_InterfaceFifoQueueElementRamReadIdxOfInterfaceFifoQueueRamType, PDUR_CODE) PduR_IFQ_GetInterfaceFifoQueueElementRamReadIdxSafe(PduR_InterfaceFifoQueueRomIterType interfaceFifoQueueRomIdx, PduR_MemIdxType memIdx);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(PduR_InterfaceFifoQueueElementRamWriteIdxOfInterfaceFifoQueueRamType, PDUR_CODE) PduR_IFQ_GetInterfaceFifoQueueElementRamWriteIdxSafe(PduR_InterfaceFifoQueueRomIterType interfaceFifoQueueRomIdx, PduR_MemIdxType memIdx);
#endif
 ...
 *  \pre        -
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(boolean, PDUR_CODE) PduR_IFQ_IsQueueFull(PduR_InterfaceFifoQueueRomIterType interfaceFifoQueueRomIdx, PduR_MemIdxType memIdx);
#endif
 ...
 *  \pre        -
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(boolean, PDUR_CODE) PduR_IFQ_IsQueueEmpty(PduR_InterfaceFifoQueueRomIterType interfaceFifoQueueRomIdx, PduR_MemIdxType memIdx);
#endif
 ...
 *  \pre        -
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_IFQ_IncrementReadIdx(PduR_InterfaceFifoQueueRomIterType interfaceFifoQueueRomIdx, PduR_MemIdxType memIdx);
#endif
 ...
 *  \pre        -
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_IFQ_IncrementWriteIdx(PduR_InterfaceFifoQueueRomIterType interfaceFifoQueueRomIdx, PduR_MemIdxType memIdx);
#endif
...
FUNC(Std_ReturnType, PDUR_CODE) PduR_IFQ_PutFifo(PduR_RmGDestRomIterType rmGDestRomIdx, PduR_RmDestRomIterType rmDestRomIdx, PduLengthType pduLength, SduDataPtrType sduDataPtr)
{
  ...
  else
  {
    ...
    PduR_InterfaceFifoQueueArrayRamEndIdxOfInterfaceFifoQueueRomType offset = (interfaceFifoQueueElementRamWriteIdx - startIdxOfQueue) * PduR_GetMaxPduLengthOfInterfaceFifoQueueRom(interfaceFifoQueueRomIdx, memIdx);

    PduR_SetActualLengthOfInterfaceFifoQueueElementRam(interfaceFifoQueueElementRamWriteIdx, pduLength, memIdx); /* SBSW_PDUR_CSL03 */
    PduR_Core_MemCpyRamToRam(PduR_GetAddrInterfaceFifoQueueArrayRam(PduR_GetInterfaceFifoQueueArrayRamStartIdxOfInterfaceFifoQueueRom(interfaceFifoQueueRomIdx, memIdx), memIdx) + offset, sduDataPtr, pduLength);   /* PRQA S 0315 */ /* MD_MSR_VStdLibCopy */ /* SBSW_PDUR_MEM_CPY_FIFOMGR */
...
FUNC(Std_ReturnType, PDUR_CODE) PduR_IFQ_GetNextElement(PduR_RmGDestRomIterType rmGDestRomIdx, P2VAR(PduR_RmDestRomIterType, AUTOMATIC, PDUR_APPL_DATA) rmDestRomIdx, P2VAR(PduInfoType, AUTOMATIC, PDUR_APPL_DATA) info)
{
  ...
  else
  {
    ...
    PduR_InterfaceFifoQueueArrayRamEndIdxOfInterfaceFifoQueueRomType offset = (interfaceFifoQueueElementRamReadIdx - startIdxOfQueue) * PduR_GetMaxPduLengthOfInterfaceFifoQueueRom(interfaceFifoQueueRomIdx, memIdx);

    info->SduDataPtr = PduR_GetAddrInterfaceFifoQueueArrayRam(PduR_GetInterfaceFifoQueueArrayRamStartIdxOfInterfaceFifoQueueRom(interfaceFifoQueueRomIdx, memIdx), memIdx) + offset; /* SBSW_PDUR_VALID_PTR_ENSURED_BY_CALLING_FUNCTION */
