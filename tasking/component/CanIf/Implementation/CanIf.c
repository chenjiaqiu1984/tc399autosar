...
#if (CANIF_CBK_MINOR_VERSION != 0x07u)
...
#if (CANIF_TYPES_MINOR_VERSION != 0x20u)
...
#if (CANIF_API_MINOR_VERSION != 0x25u)
...
# define CANIF_FDFLAGSHIFTPOS   30u
...
# define CANIF_FDFLAGSHIFTPOS   14u
/* coded in CANIF_CFG_RX_MASK */
...
/* OUT: 0: None FD / 1: FD */
#define CanIf_GetShiftedFdFlag(canId) (uint8)(((canId) & CANIF_FDFLAG) >> CANIF_FDFLAGSHIFTPOS) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
#  endif          
    {
      ...
      CANIF_VAR_SET_TXBUFFERPRIOBYCANIDBITQUEUE_QUEUEFLAGS(queueElementIdx, (CANIF_VAR_TXBUFFERPRIOBYCANIDBITQUEUE_QUEUEFLAGS(queueElementIdx) & ((CanIf_TxQueueFlagType) ~CanShiftLookUp[elementBitIdx]))); /* SBSW_CANIF_20 */
...
Relation_Context:
CanIfTxBuffer, CanIfOneChOpt, CanIfControllerAmount # from this local function #
CanIfTxBuffer, CanIfOneChOpt, CanIfControllerAmount # from caller CanIf_Init, CanIf_SetControllerModeSubSwitch, CanIf_ControllerBusOff, CanIf_SetPduMode #
Relation:
CanIfTxBuffer
CanIfTxBuffer, CanIfTransmitCancellationAPI
CanIfOneChOpt, CanIfControllerAmount, TxBasicAmount # CanIfControllerAmount/TxBasicAmount: Data variance for amount of Tx-Buffer per controller #
CanIfTxBuffer
CanIfTxBuffer, CanIfTransmitCancellationAPI
CanIfTxBuffer, CanIfTransmitCancellationAPI, CanIfOneChOpt, CanIfControllerAmount
Parameter_PreCompile:
Parameter_Data:
Constrain:
|<DataModelEnd>|
...
Relation:
CanIfOneChOpt, CanIfControllerAmount
Parameter_PreCompile:
Parameter_Data:
Constrain:
|<DataModelEnd>|
...
#   endif
  {
    if(CANIF_CFG_CTRLJ1939DYNADDRSUPPORT(CanIf_Controller_Value_Local) != CANIF_J1939_DYN_ADDR_DISABLED ) /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
    {
...
#   if (CANIF_ONE_CONTROLLER_OPTIMIZATION == STD_OFF) /* COV_CANIF_ONE_CHANNEL_OPTIMIZATION_UNSUPPORTED */
      ...
      if(CANIF_CFG_CTRLID2J1939DYNADDROFFSET(CanIf_Controller_Value_Local) > maxAddrOffset)
      {
        maxAddrOffset = (uint16)CANIF_CFG_CTRLID2J1939DYNADDROFFSET(CanIf_Controller_Value_Local);
      }
#   endif
    }
  }
...
CanIfDynTx
CanIfOneChOpt, CanIfControllerAmount
CanIfOneChOpt, CanIfControllerAmount, CanIfTxBuffer
CanIfPnEnable, CanIfOneChOpt, CanIfControllerAmount
CanIfTxConfPollSupport, CanIfOneChOpt, CanIfControllerAmount
CanIfJ1939, CanIfOneChOpt, CanIfControllerAmount
CanIfBusMirroringSupport, CanIfOneChOpt, CanIfControllerAmount
CanIfTxBuffer, CanIfTransmitCancellationAPI
...
# if (CANIF_J1939_DYN_ADDR_SUPPORT != CANIF_J1939_DYN_ADDR_DISABLED)
  ...
  else if(CanIf_InitSubCheckJ1939AddrTables() == E_NOT_OK) /* PRQA S 2992, 2996 */ /* MD_CanIf_J1939ConstData */ /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
  {
    errorId = CANIF_E_FATAL;
  }
# endif
...
Relation_Context:
CanIfOneChOpt, CanIfControllerAmount # from this local function #
CanIfOneChOpt, CanIfControllerAmount # from caller CanIf_SetControllerMode #
Relation:
CanIfMultipleDriver, CanIfOneChOpt, CanIfControllerAmount
CanIfOneChOpt, CanIfControllerAmount
CanIfTxBuffer
CanIfOneChOpt, CanIfControllerAmount
CanIfWakeupValidation, CanIfOneChOpt, CanIfControllerAmount
CanIfOneChOpt, CanIfControllerAmount
CanIfDevErrorDetect
Parameter_PreCompile:
Parameter_Data:
...
CanIfDevErrorDetect, CanIfOneChOpt, CanIfControllerAmount
CanIfDevErrorDetect, CanIfMultipleDriver, CanIfVariant, CanIfOneChOpt, CanIfControllerAmount
CanIfDevErrorDetect, CanIfOneChOpt, CanIfControllerAmount
CanIfOneChOpt, CanIfControllerAmount
CanIfDevErrorDetect
CanIfOneChOpt, CanIfControllerAmount, CanIfDevErrorDetect
Parameter_PreCompile:
Parameter_Data:
Constrain:
|<DataModelEnd>|
...
Relation_Context:
CanIfOneChOpt # from this API #
Relation:
CanIfDevErrorDetect
CanIfDevErrorDetect, CanIfVariant
CanIfDevErrorDetect
CanIfOneChOpt, CanIfDevErrorDetect
Parameter_PreCompile:
Parameter_Data:
Constrain:
|<DataModelEnd>|
...
Relation_Context:
CanIfPnEnable, CanIfOneChOpt, CanIfControllerAmount # from this local function #
CanIfPnEnable, CanIfOneChOpt, CanIfControllerAmount # from caller CanIf_Transmit #
Relation:
CanIfOneChOpt, CanIfControllerAmount
Parameter_PreCompile:
Parameter_Data:
...
Relation_Context:
CanIfJ1939, CanIfOneChOpt, CanIfControllerAmount # from this local function #
CanIfJ1939, CanIfOneChOpt, CanIfControllerAmount # from caller CanIf_Transmit #
Relation:
CanIfOneChOpt, CanIfControllerAmount
CanIfJ1939
CanIfJ1939, CanIfOneChOpt, CanIfControllerAmount
...
CANIF_LOCAL_INLINE FUNC(Std_ReturnType, CANIF_CODE) CanIf_TransmitSubJ1939DynAddr(CANIF_CHANNEL_CANTYPE_FIRST P2VAR(Can_PduType, AUTOMATIC, AUTOMATIC)localPduPtr)
{
  ...
  if( CANIF_CFG_CTRLJ1939DYNADDRSUPPORT(CanIf_Controller_Value) != CANIF_J1939_DYN_ADDR_DISABLED ) /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
  {
    ...
    if(((localPduPtr)->id & CANIF_EXT_CANID_MASK) == CANIF_EXT_CANID_MASK) /* ext. ID */ /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
    {
      ...
      if ((((localPduPtr)->id & CANIF_J1939_DATA_PAGE_MASK) != CANIF_J1939_DATA_PAGE_MASK) && (((localPduPtr)->id & CANIF_J1939_PGN_MASK) != CANIF_J1939_AC_PGN))
      {
        ...
        if (((localPduPtr)->id & CANIF_J1939_MIN_PDU2_MASK) < CANIF_J1939_MIN_PDU2_MASK)  /* PDU Format 1 (second byte < 0xF0) */
        {
          ...
          {
            if (((localPduPtr)->sdu != NULL_PTR) && ((localPduPtr)->length > CANIF_J1939_ACKM_ACKADDR_POS))
            {
              ackAddr = CANIF_VAR_J1939TXADDR_LOOKUP(CanIf_Controller_Value, (localPduPtr)->sdu[CANIF_J1939_ACKM_ACKADDR_POS]);
...
#  if (CANIF_J1939_DYN_ADDR_SUPPORT == CANIF_J1939_DYN_ADDR_MIXED_CANID)
    else
    {
      ...
      if( CANIF_CFG_CTRLJ1939DYNADDRSUPPORT(CanIf_Controller_Value) != CANIF_J1939_DYN_ADDR_EXT_CANID ) /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
      {
...
Relation:
CanIfVStdLibCopy
CanIfVStdLibCopy, CanIfFdSupport # used for CANIF_STATIC_FD_TXQUEUE #
CanIfDynTx, CanIfJ1939, CanIfTxMetaDataSupport
CanIfVStdLibCopy, CanIfTxBuffer
Parameter_PreCompile:
Parameter_Data:
Constrain:
|<DataModelEnd>|
...
CanIfTxBuffer
CanIfDevErrorDetect
CanIfTxBuffer, CanIfVStdLibCopy
CanIfTxBuffer
...
# endif /* CANIF_DEV_ERROR_DETECT == STD_ON */
  {
...
#endif /* CANIF_DEV_ERROR_DETECT == STD_ON */
    {
      ...
      /* #50 Check if CAN channel is initialized */
...
# endif /* CANIF_POSTBUILD_VARIANT_SUPPORT == STD_ON */
#endif /* CANIF_DEV_ERROR_DETECT == STD_ON */
      {
        ...
        if (CANIF_DO_TRANSMIT == CanIf_TransmitSubHandleTxPduFilter(CANIF_CHANNEL_CANPARA_FIRST_LOCAL CanTxPduId))
#endif
        {
          /* #200 Process only if CAN channel is started */
...
CanIfPnEnable, CanIfTxConfPollSupport, CanIfOneChOpt, CanIfControllerAmount
CanIfPnEnable, CanIfOneChOpt, CanIfControllerAmount
CanIfTxConfPollSupport,  CanIfOneChOpt, CanIfControllerAmount
CanIfTxBuffer
CanIfDevErrorDetect
...
#  if (CANIF_J1939_DYN_ADDR_SUPPORT == CANIF_J1939_DYN_ADDR_MIXED_CANID)
    ...
    {
      /* #300 Standard CAN identifier: */
      if( CANIF_CFG_CTRLJ1939DYNADDRSUPPORT(CanIf_Controller_Value_Local) == CANIF_J1939_DYN_ADDR_MIXED_CANID ) /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
      {
        /* #310 Only source address is substituted */
        sa = (uint8)((rxSearchParams->eCanId) & CANIF_J1939_SA_MASK);
...
CANIF_LOCAL_INLINE FUNC(void, CANIF_CODE) CanIf_RxIndicationSubLinearSearch(P2VAR(CanIf_RxSearchParamsType, AUTOMATIC, AUTOMATIC) rxSearchParams) /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
{
  ...
  while (((CANIF_CFG_RX_MASK(rxSearchParams->eRxPduId) & CANIF_RANGE_FLAG) != CANIF_RANGE_FLAG)) /* PRQA S 0771 */ /* MD_CanIf_MultipleBreak */ /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
  {
...
CANIF_LOCAL_INLINE FUNC(void, CANIF_CODE) CanIf_RxIndicationSubRangeSearch(P2VAR(CanIf_RxSearchParamsType, AUTOMATIC, AUTOMATIC) rxSearchParams) /* COV_CANIF_NO_RANGE_SEARCH */
{
  ...
  while ((CANIF_CFG_RX_MASK(rxSearchParams->eRxPduId) & (CANIF_STOP_FLAG | CANIF_RANGE_FLAG)) == CANIF_RANGE_FLAG) /* PRQA S 0771 */ /* MD_CanIf_MultipleBreak */ /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
  {
    /* #110 Handle code-mask Rx-range */
    if ((CANIF_CFG_RX_CANID(rxSearchParams->eRxPduId) & CANIF_MASKCODE_RANGE) == CANIF_MASKCODE_RANGE) /* PRQA S 2992, 2996 */ /* MD_CanIf_RxPduConstData */
    {
      if (CANIF_CFG_RX_CANID(rxSearchParams->eRxPduId) == ((rxSearchParams->eCanId & (CANIF_CFG_RX_MASK(rxSearchParams->eRxPduId) )) | CANIF_MASKCODE_RANGE )) /* PRQA S 2996 */ /* MD_CanIf_RxPduConstData */
      {
...
CanIfRxMetaDataSupport, CanIfVStdLibCopy
CanIfRxMetaDataSupport, CanIfIDType
CanIfRxMetaDataSupport, CanIfJ1939, CanIfOneChOpt, CanIfControllerAmount
CanIfDevErrorDetect
...
Relation_Context:
Relation:
CanIfSecurityEventReporting
CanIfDevErrorDetect
CanIfDevErrorDetect, CanIfVariant
CanIfOneChOpt, CanIfControllerAmount
CanIfTxBuffer, CanIfOneChOpt, CanIfControllerAmount
CanIfTxConfPollSupport, CanIfOneChOpt, CanIfControllerAmount
CanIfOneChOpt, CanIfControllerAmount
CanIfSecurityEventReporting
CanIfDevErrorDetect
...
#if ((CANIF_ONE_CONTROLLER_OPTIMIZATION == STD_ON) && (CANIF_DEV_ERROR_DETECT == STD_OFF) && (CANIF_ENABLE_SECURITY_EVENT_REPORTING == STD_OFF)) /* COV_CANIF_ONE_CHANNEL_OPTIMIZATION_UNSUPPORTED */
    CANIF_DUMMY_STATEMENT(ControllerId); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
#endif
} /* PRQA S 6080 */ /* MD_MSR_STMIF */
...
CanIfDevErrorDetect, CanIfVariant
CanIfTransceiverMapping
CanIfTransceiverMapping, CanIfOneChOpt, CanIfControllerAmount, CanIfTransceiverHandling
CanIfTransceiverMapping, CanIfDevErrorDetect, CanIfOneChOpt, CanIfControllerAmount, CanIfTransceiverHandling
CanIfOneChOpt, CanIfControllerAmount
CanIfOneChOpt, CanIfControllerAmount, CanIfTransceiverHandling
CanIfOneChOpt, CanIfControllerAmount, CanIfDevErrorDetect
CanIfOneChOpt, CanIfControllerAmount, CanIfTransceiverHandling
CanIfDevErrorDetect
CanIfDevErrorDetect, CanIfOneChOpt, CanIfControllerAmount
...
CanIfDevErrorDetect
CanIfDevErrorDetect, CanIfOneChOpt, CanIfControllerAmount
CanIfDevErrorDetect, CanIfOneChOpt, CanIfControllerAmount, CanIfTransceiverHandling
CanIfOneChOpt, CanIfControllerAmount, CanIfTransceiverHandling
CanIfDevErrorDetect
CanIfDevErrorDetect, CanIfOneChOpt, CanIfControllerAmount
Parameter_PreCompile:
...
#  endif
              {
                ...
                {
                  localRetval = CanIf_AdaptCanCheckWakeupRetVal(canCheckWakeupFct(CANIF_CFG_CTRLUPTOLOWMAP_CHANNELINDEX(wuTrgtaddress)));  /* SBSW_CANIF_41 */
                }
              }
...
#   endif /* CANIF_ONE_CONTROLLER_OPTIMIZATION == STD_OFF */
  ...
  else if (CANIF_CFG_CTRLJ1939DYNADDRSUPPORT(CanIf_Controller_Value) == CANIF_J1939_DYN_ADDR_DISABLED) /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
  {
    errorId = CANIF_E_PARAM_CONTROLLERID;
  }
  /* Checks for parameters busAddr and intAdr are not needed here; validity is secured by datatype and runtime check during CanIf_Init() see SBSW_CANIF_48 */
  else
#  endif /* CANIF_DEV_ERROR_DETECT == STD_ON */
  {
    /* ----- Implementation ----------------------------------------------- */
    ...
    {
      CANIF_VAR_SET_J1939RXADDR_LOOKUP(CanIf_Controller_Value, oldBusAddr, CANIF_J1939_NULL_ADDR); /* SBSW_CANIF_48 */
    }
    CANIF_VAR_SET_J1939RXADDR_LOOKUP(CanIf_Controller_Value, busAddr, intAddr); /* SBSW_CANIF_48 */
    CANIF_VAR_SET_J1939TXADDR_LOOKUP(CanIf_Controller_Value, intAddr, busAddr); /* SBSW_CANIF_48 */
...
#   endif /* CANIF_ONE_CONTROLLER_OPTIMIZATION == STD_OFF */
  ...
  /* Check for parameter intAdr is not needed here; validity is secured by datatype and runtime check during CanIf_Init() see SBSW_CANIF_48 */
  else
#  endif /* CANIF_DEV_ERROR_DETECT == STD_ON */
  {
    /* ----- Implementation ----------------------------------------------- */
    ...
    CANIF_VAR_SET_J1939RXADDR_LOOKUP(CanIf_Controller_Value, busAddr, CANIF_J1939_NULL_ADDR); /* SBSW_CANIF_48 */
    CANIF_VAR_SET_J1939TXADDR_LOOKUP(CanIf_Controller_Value, intAddr, CANIF_J1939_NULL_ADDR); /* SBSW_CANIF_48 */
 ...
 *
 */
FUNC(void, CANIF_CODE) CanIf_ControllerErrorStatePassive(uint8 ControllerId, uint8 RxErrorCounter, uint8 TxErrorCounter)
{
  /* ----- Local Variables ---------------------------------------------- */
  uint8 errorId = CANIF_E_NO_ERROR;
...
# endif
  {
    ...
    /* #110 Determine security event from CanError */
    ...
    {
      /* #200 Report rx security event to the IdsM (CanErrorType is rx) */
      IdsM_SetSecurityEventWithContextData(CANIF_SEV_RX_ERROR_DETECTED, (CONSTP2CONST(IdsM_ContextDataType, AUTOMATIC, IDSM_APPL_DATA)) contextData, CANIF_CONTEXTDATA_SIZE_CANERROR); /* SBSW_CANIF_5 */
            ...
            (CanError == CAN_ERROR_ACK_DELIMITER) || (CanError == CAN_ERROR_ABITRATION_LOST) ||
            (CanError == CAN_ERROR_OVERLOAD))
    {
      /* #300 Report tx security event to the IdsM (CanErrorType is tx) */
    ...
    {
      /* #400 Report rx and tx security event to the IdsM (CanErrorType is not available) */
      /* Rx or tx error can not be determined from this error type, therefore report security event for rx and tx */
      contextData[CANIF_CONTEXTDATA_CANERROR_POS] = (IdsM_ContextDataType)CAN_ERROR_TYPE_NOT_AVAILABLE; /* SBSW_CANIF_51 */
      IdsM_SetSecurityEventWithContextData(CANIF_SEV_RX_ERROR_DETECTED, (CONSTP2CONST(IdsM_ContextDataType, AUTOMATIC, IDSM_APPL_DATA)) contextData, CANIF_CONTEXTDATA_SIZE_CANERROR); /* SBSW_CANIF_5 */
      IdsM_SetSecurityEventWithContextData(CANIF_SEV_TX_ERROR_DETECTED, (CONSTP2CONST(IdsM_ContextDataType, AUTOMATIC, IDSM_APPL_DATA)) contextData, CANIF_CONTEXTDATA_SIZE_CANERROR); /* SBSW_CANIF_5 */
    }
  }
...
\COUNTERMEASURE \N A error directive verifies that: CANIF_CFG_MAXRXDLC_PLUS_MAXMETADATALEN > CANIF_J1939_ACKM_ACKADDR_POS
...
\COUNTERMEASURE \N In Canif_Init() is checked against CanIf_GetSizeOfJ1939RxAddr_Lookup/CanIf_GetSizeOfJ1939TxAddr_Lookup that each controller with activated J1939 support has a space of 256 elements in these tables.
                   ...
                   If the address table configuration check in Canif_Init() fails, all CAN controllers will be in state uninitialized.
