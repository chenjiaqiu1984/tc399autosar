 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE Os_AddressOfConstType, OS_CODE,
OS_ALWAYS_INLINE, Os_TrapCallGetExceptionAddress,
(
  void
));
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE void, OS_CODE,
OS_ALWAYS_INLINE, Os_TrapCallGetCoreStartState,
(
  CoreIdType CoreID,
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_AddressOfConstType, OS_CODE,
OS_ALWAYS_INLINE, Os_TrapCallGetExceptionAddress,
(
  void
))
