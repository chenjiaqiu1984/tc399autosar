...
/* module specific MISRA deviations:
  ...
  MD_Os_Rule2.2_2987_Config:
      Reason:     Whether this function has a side effect, depends on a configuration parameter.
      Risk:       None, because in other configurations the function has a side effect.
      Prevention: None.
