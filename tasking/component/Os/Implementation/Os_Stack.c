...
{
  if(Os_StackIsMeasurementEnabled() != 0u)                                                                              /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
...
)
{
  ...
  if(Os_StackIsMeasurementEnabled() == 0u)                                                                              /* COV_OS_INVSTATE */ /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
    Os_ErrKernelPanic();
  }
...
)
{
  ...
  if(Os_StackIsMeasurementEnabled() == 0u)                                                                              /* PRQA S 2992, 2996 */ /* MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2996 */
  {
    result = 0;
