...
\ID COV_OS_HAL_CORE_BETA
   \ACCEPT TX
   \ACCEPT XX
   \REASON Currently this code cannot be covered since the new supported derivative (TC49x) has beta state and cannot
           be put under regression (see ESCAN00107389)

\ID COV_OS_HAL_INTERRUPTCONTROLLER_BETA
   \ACCEPT TX
   \ACCEPT XX
   \REASON Currently this code cannot be covered since the new supported derivative (TC49x) has beta state and cannot
           be put under regression (see ESCAN00107389)

\ID COV_OS_HAL_TIMER_BETA
   \ACCEPT TX
   \ACCEPT XF
   \REASON Currently this code cannot be covered since the new supported derivative (TC49x) has beta state and cannot
           be put under regression (see ESCAN00107389)
