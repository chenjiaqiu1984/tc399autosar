...
OS_FUNC_ATTRIBUTE_DEFINITION(void, OS_CODE, OS_NORETURN, Os_ThreadSuicide, (void))
{
  ...
  /* Invalid OS state. */
  Os_ErrKernelPanic(); /* function never returns! */                                                                    /* PRQA S 2880 */ /* MD_Os_Rule2.1_2880_NonReturning */ /* COMP_WARN_OS_UNREACHABLE_CODE */
}
...
\CM CM_OS_THREADGETTRACE_M
      Verify that the Trace reference in each thread instance is no NULL_PTR, if ORTI or TimingHook tracing is enabled.
