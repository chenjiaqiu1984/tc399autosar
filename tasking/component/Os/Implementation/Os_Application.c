...
)
{
  ...
  /* #10 Initialize tasks. */
  for(index = 0; index < (Os_ObjIdx_IteratorType) App->TaskCount; index++)
  {
    Os_TaskInit(App->TaskRefs[index], AppMode);                                                                         /* SBSW_OS_APP_TASKINIT_001 */
  }

  /* #20 Initialize ISRs. */
  for(index = 0; index < (Os_ObjIdx_IteratorType) App->IsrCat2Count; index++)
  {
  ...
  for(index = 0; index < (Os_ObjIdx_IteratorType) App->AlarmCount; index++)
  {
    Os_AlarmInit(App->AlarmRefs[index], AppMode);                                                                       /* SBSW_OS_APP_ALARMINIT_001 */
  }

  /* #50 Initialize Schedule Tables. */
  for(index = 0; index < (Os_ObjIdx_IteratorType) App->SchTCount; index++)
  {
...
)
{
  ...
  for(index = 0; index < (Os_ObjIdx_IteratorType) App->ServiceFunctionCount; index++)
  {
...
)
{
  ...
  for(index = 0; index < (Os_ObjIdx_IteratorType) App->HookCount; index++)
  {
