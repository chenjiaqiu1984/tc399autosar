 ...
 *  \details        Call Vector timing hook for scheduling and store curent task for ORTI if configured.
 *
 ...
 *  \details        Call the Vector timing hook which signals task activation.
 *
 ...
 *  \details        Call the vector timing hok which signals the setting of an event.
 *
 ...
 *  \details        Call the Vector timing hooks which signal that a spinlock or an internal spinlock has been taken.
 *
 *  \param[in]      Spinlock        The trace object for the spinlock.
 *                                  Parameter must not be NULL if tracing is enabled.
 *
 ...
 *  \details        Call the Vector timing hooks which signal that a spinlock or an internal spinlock has been released.
 *
 *  \param[in]      Spinlock        The trace object for the spinlock.
 *                                  Parameter must not be NULL if tracing is enabled.
 *
