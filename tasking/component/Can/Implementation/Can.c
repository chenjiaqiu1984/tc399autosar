...
#endif
#if( DRVCAN_MPC5700MCANASR_VERSION != 0x0508)
# error "Source and Header file are inconsistent!"
#endif

#if( DRVCAN_MPC5700MCANASR_RELEASE_VERSION != 0x02)
# error "Source and Header file are inconsistent!"
#endif
 ...
 *
 */
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_WriteProtectedReg32(CAN_CHANNEL_CANTYPE_FIRST vuint16 area, CanChipMsgPtr32 regPtr, vuint32 value, vuint32 readMask, CanInitParaStructPtr initPara ) /* PRQA S 3673 */ /* MD_Can_NoneConstParameterPointer */ /* COV_CAN_PROTECTED_WRITE_LL */
{
  vuint8 result = kCanFalse;
  /* #10 write register value */
...
# endif
  ...
  /* Initialization */
  if ((Cn->CCCR & kCanCCCR_INIT) != kCanCCCR_INIT ) /* If Init-Bit is not set */ /* PRQA S 2842 */ /* MD_Can_Assertion */
  {
    Cn->CCCR  = kCanCCCR_INIT; /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
    CanLL_ApplCanTimerStart(kCanLoopInit); /* PRQA S 2842 */ /* MD_Can_Assertion */ /* SBSW_CAN_LL_101 */
    while( ((Cn->CCCR & kCanCCCR_INIT) == 0UL) && (CanLL_ApplCanTimerLoop(kCanLoopInit) !=  CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303,2842 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess,MD_Can_Assertion */ /* COV_CAN_HW_SPECIFIC */
    {/* Assure that INIT has been accepted. */}
    CanLL_ApplCanTimerEnd(kCanLoopInit); /* SBSW_CAN_LL_101 */
  }

  /* Configuration Change Enable */
  Cn->CCCR |= kCanCCCR_CCE; /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
  CanLL_ApplCanTimerStart(kCanLoopInit); /* PRQA S 2842 */ /* MD_Can_Assertion */ /* SBSW_CAN_LL_101 */
  while( ((Cn->CCCR & kCanCCCR_CCE) == 0UL) && (CanLL_ApplCanTimerLoop(kCanLoopInit) !=  CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303,2842 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess,MD_Can_Assertion */ /* COV_CAN_HW_SPECIFIC */
  {/* Assure that CCE has been accepted. */}
  CanLL_ApplCanTimerEnd(kCanLoopInit); /* SBSW_CAN_LL_101 */
  
  Cn->IE  = 0x00000000u; /* PRQA S 2842 */ /* MD_Can_Assertion */ /* SBSW_CAN_LL_100 */  /* Disable MCAN Interrupts */
  ...
  for(indx = 0x00u; indx < 4u; indx++)
    { 
      ...
      Cn->CCCR = (((kCanRegCheckMaskCCCR ^ kCanRegCheckMaskCCCR_RP) & CanRegCheckValues32bit[indx])|kCanRegCheckMaskCCCR_RP); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
       
      /* Data Bit Timing & Prescaler Register (FBTP),RP */ 
      Cn->FBTP = (kCanRegCheckMaskFBTP & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */

      /* RAM Watchdog (RWD), RP */
      Cn->RWD  = (kCanRegCheckMaskRWD  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Bit Timing and Prescaler Register (BTP/NBTP), RP */
      Cn->BTP = (kCanRegCheckMaskBTP  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      
      /* Timestamp Counter Configuration (TSCC), RP */
      Cn->TSCC = (kCanRegCheckMaskTSCC  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */  /*! Not supported but initialized */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Timeout Counter Configuration (TOCC), RP */
      Cn->TOCC = (kCanRegCheckMaskTOCC  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */  /*! Not supported but initialized */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Timeout Counter Value (TOCV), RC */ 
      
      /* Transmitter Delay Compensation Register (TDCR), RP */
      {
#  if ( CAN_MCAN_REVISION >= 0x0310UL ) /* COV_CAN_HW_SPECIFIC */ 
        Cn->TDCR = (kCanRegCheckMaskTDCR  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
#  endif /* MCAN Core Release < 0x0310UL */
      }
    
      /* Global Filter Configuration (GFC),RP */
      Cn->GFC = (kCanRegCheckMaskGFC  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Standard ID Filter Configuration (SIDFC), RP */
      Cn->SIDFC = (kCanRegCheckMaskSIDFC  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Extended ID Filter Configuration (XIDFC), RP */
      Cn->XIDFC = (kCanRegCheckMaskXIDFC  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Extended ID AND Mask (XIDAM), RP */
      Cn->XIDAM = (kCanRegCheckMaskXIDAM  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Rx FIFO 0 Configuration (RXF0C), RP */
      Cn->RXF0C.R = (kCanRegCheckMaskRXF0C  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Rx FIFO 0 Acknowledge (RXF0A), RW */
      Cn->RXF0A = (kCanRegCheckMaskRXF0A  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Rx Buffer Configuration (RXBC), RP */ 
      Cn->RXBC = (kCanRegCheckMaskRXBC  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Rx FIFO 1 Configuration (RXF1C), RP */
      Cn->RXF1C.R = (kCanRegCheckMaskRXF1C  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Rx FIFO 1 Acknowledge (RXF1A), RW */
      Cn->RXF1A = (kCanRegCheckMaskRXF1A  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Rx Buffer / FIFO Element Size Configuration (RXESC), RP */ 
      Cn->RXESC.R = (kCanRegCheckMaskRXESC  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Tx Buffer Configuration (TXBC) */
      Cn->TXBC = (kCanRegCheckMaskTXBC  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Tx Buffer Element Size Configuration (TXESC) */ 
      Cn->TXESC = (kCanRegCheckMaskTXESC  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */ /* PRQA S 2842 */ /* MD_Can_Assertion */
      /* Tx Buffer Transmission Interrupt Enable (TXBTIE), RW */
      Cn->TXBTIE = (kCanRegCheckMaskTXBTIE  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */  /* PRQA S 2986,4558,2842 */ /* MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_Assertion */
      /* Tx Event FIFO Configuration (TXEFC) */
      Cn->TXEFC = (kCanRegCheckMaskTXEFC  & CanRegCheckValues32bit[indx]); /* SBSW_CAN_LL_100 */  /* Not supported but initialized */ /* PRQA S 2842 */ /* MD_Can_Assertion */
    
      /* #30 Check if register values are valid  */ 
      if(
          ( (Cn->FBTP    & kCanRegCheckMaskFBTP)  != (kCanRegCheckMaskFBTP  & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->CCCR & (kCanRegCheckMaskCCCR ^ kCanRegCheckMaskCCCR_RP))!= ((kCanRegCheckMaskCCCR ^ kCanRegCheckMaskCCCR_RP) & CanRegCheckValues32bit[indx]) ) || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->BTP     & kCanRegCheckMaskBTP)   != (kCanRegCheckMaskBTP   & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->CCCR & (kCanCCCR_CCE | kCanCCCR_INIT))                     != (kCanCCCR_CCE | kCanCCCR_INIT)) || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->RWD     & kCanRegCheckMaskRWD)   != (kCanRegCheckMaskRWD   & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->TSCC    & kCanRegCheckMaskTSCC)  != (kCanRegCheckMaskTSCC  & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->TOCC    & kCanRegCheckMaskTOCC)  != (kCanRegCheckMaskTOCC  & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
# if ( CAN_MCAN_REVISION >= 0x0310UL ) /* COV_CAN_HW_SPECIFIC */
          ( (Cn->TDCR    & kCanRegCheckMaskTDCR)  != (kCanRegCheckMaskTDCR  & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
# endif /* MCAN Core Release < 0x0310UL */ 
          ( (Cn->GFC     & kCanRegCheckMaskGFC)   != (kCanRegCheckMaskGFC   & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->SIDFC   & kCanRegCheckMaskSIDFC) != (kCanRegCheckMaskSIDFC & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->XIDFC   & kCanRegCheckMaskXIDFC) != (kCanRegCheckMaskXIDFC & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->XIDAM   & kCanRegCheckMaskXIDAM) != (kCanRegCheckMaskXIDAM & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->RXF0C.R & kCanRegCheckMaskRXF0C) != (kCanRegCheckMaskRXF0C & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->RXF0A   & kCanRegCheckMaskRXF0A) != (kCanRegCheckMaskRXF0A & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->RXBC    & kCanRegCheckMaskRXBC)  != (kCanRegCheckMaskRXBC  & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->RXF1C.R & kCanRegCheckMaskRXF1C) != (kCanRegCheckMaskRXF1C & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->RXF1A   & kCanRegCheckMaskRXF1A) != (kCanRegCheckMaskRXF1A & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->RXESC.R & kCanRegCheckMaskRXESC) != (kCanRegCheckMaskRXESC & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->TXBC    & kCanRegCheckMaskTXBC)  != (kCanRegCheckMaskTXBC  & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->TXESC   & kCanRegCheckMaskTXESC) != (kCanRegCheckMaskTXESC & CanRegCheckValues32bit[indx]))   || /* PRQA S 2842 */ /* MD_Can_Assertion */
          ( (Cn->TXBTIE  & kCanRegCheckMaskTXBTIE)!= (kCanRegCheckMaskTXBTIE& CanRegCheckValues32bit[indx]))   ||  /* PRQA S 2986,4558,2842 */ /* MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_Assertion */
          ( (Cn->TXEFC   & kCanRegCheckMaskTXEFC) != (kCanRegCheckMaskTXEFC & CanRegCheckValues32bit[indx]))    ) /* COV_CAN_HARDWARE_FAILURE */ /* PRQA S 2842 */ /* MD_Can_Assertion */
          {
            ret_val = kCanTrue; 
          }
...
#  if defined( C_ENABLE_STD_ID ) && (kCanNumberOfStandardFilter > 0)  
  for(index = 0u; index < Can_GetCanSIDFC_LSSOfCanSIDFC(canHwChannel); index++)  /* SBSW_CAN_LL_109 */ /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */
  {
...
#  if defined(C_ENABLE_EXTENDED_ID) && (kCanNumberOfExtendedFilter > 0)
  for(index = 0u; index < Can_GetCanXIDFC_LSEOfCanXIDFC(canHwChannel); index++)  /* SBSW_CAN_LL_109 */ /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */
  { 
...
#  if defined( C_ENABLE_STD_ID ) && (kCanNumberOfStandardFilter > 0)  /* at least one std filter is available */
  ...
  for(index = 0u; index < Can_GetCanSIDFC_LSSOfCanSIDFC(canHwChannel); index++) /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */
  { 
...
#  if defined(C_ENABLE_EXTENDED_ID) && (kCanNumberOfExtendedFilter > 0)
  ...
  for(index = 0u; index < Can_GetCanXIDFC_LSEOfCanXIDFC(canHwChannel); index++) /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */
  { 
    /* If Filter is configured to ( RXFIFO0 OR RXFIFO1) AND The filter offset matches the HwObjHandle*/
...
# if defined(C_ENABLE_MULTIPLEXED_TRANSMISSION) || defined(C_ENABLE_RX_BASICCAN_OBJECTS) || defined(C_ENABLE_TX_HW_FIFO)
  for (;(( mailboxElement < Can_GetMailboxSize(initPara->mailboxHandle) ) && (ret_val == kCanFalse)); mailboxElement++) /* COV_CAN_HARDWARE_FAILURE */
# endif
  {

    /* If TX Buffer */
    if((initPara->mailboxHandle) < CAN_HL_MB_TX_BASIC_STOPINDEX(canHwChannel)) /* PRQA S 2992,2996 */ /* MD_Can_ConstValue */
    {
...
# if defined( C_ENABLE_RX_FULLCAN_OBJECTS )
    else if ((initPara->mailboxHandle) < CAN_HL_MB_RX_FULL_STOPINDEX(canHwChannel))
    {
    ...
    { /* found valid handle */
      ...
      else
      {
        ...
        { /* PRQA S 0303 QAC_Can_0303 */ /* MD_Can_HwAccess */
          vuint8 j;
# if defined (C_ENABLE_CAN_FD_FULL)
          for(j=0u; (j < ((Can_GetMaxDataLenOfMailbox(initPara->mailboxHandle)/4u) + (8u/4u))) && (ret_val == kCanFalse);j++) /* Maximum mailbox size pluss 8 byte header */ /* COV_CAN_HARDWARE_FAILURE */
# else
...
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_TxConfSetTxConfStruct(CAN_CHANNEL_AND_HW_CHANNEL_CANTYPE_FIRST CanTxConfirmationParaStructPtr txConfPara) /* COV_CAN_GENDATA_TX_NOT_IN_ALL_CONFIG */
{
  ...
  {
    vuint8 i;
    for(i=0u; i< (Can_GetMaxDataLenOfMailbox(txConfPara->mailboxHandle)/4u) ; i++)
    {
...
#  endif
  {
    ...
    for (indx=0;indx<Can_GetSizeOfCanSubSystemBaseAdr(); indx++)
    {
...
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_TriCoreErratum_AI_H001(CAN_HW_CHANNEL_CANTYPE_FIRST vuint32 CanIrFlag)
{
  ...
  if ( (Cn->IR & CanIrFlag) != 0u ) /* PRQA S 0303 */ /* MD_Can_HwAccess */ /* COV_CAN_HARDWARE_FAILURE */
  {
    ...
    do
    {
      ...
      Cn->IR = (CanIrFlag); /* SBSW_CAN_LL_100 */ /* PRQA S 0303 */ /* MD_Can_HwAccess */
    } while( ((Cn->IR & CanIrFlag) != 0u ) && (CanLL_ApplCanTimerLoop(kCanLoopIrFlag) !=  CAN_NOT_OK) ); /* PRQA S 1881,3415,0303 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_HwAccess */
...
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_SetAllFilter(CAN_CHANNEL_CANTYPE_FIRST CanInitParaStructPtr initPara)
{
  ...
  for(initPara->tmpVal = 0; initPara->tmpVal < (Can_GetCanSIDFC_LSSOfCanSIDFC(canHwChannel)); (initPara->tmpVal)++) /* SBSW_CAN_LL_109 */  /* SBSW_CAN_LL_109 */ /* COV_CAN_GENDATA_NOT_IN_ALL_CONFIG */
...
#if defined(C_ENABLE_EXTENDED_ID) && (kCanNumberOfExtendedFilter > 0)
  for(initPara->tmpVal = 0; initPara->tmpVal < (Can_GetCanXIDFC_LSEOfCanXIDFC(canHwChannel)); (initPara->tmpVal)++) /* SBSW_CAN_LL_109 */  /* SBSW_CAN_LL_109 */ 
...
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_SetRegisterMcMcan(CAN_CHANNEL_CANTYPE_FIRST CanInitParaStructPtr localInfo)
{
 ...
 /* Node Port Control Register */
  (void)CanLL_WriteReg32(CAN_CHANNEL_CANPARA_FIRST &(Cn->NPCR),(vuint32)(Can_GetRxSelectionOfControllerConfig(canHwChannel)),kCanRegCheckMaskMCMCAN_NPCR, localInfo); /* SBSW_CAN_LL_100 */ /* SBSW_CAN_HL36 */ /* PRQA S 0303 */ /* MD_Can_HwAccess */
...
#   if defined( C_ENABLE_ISR_MANDATORY )
  ...
  if( (Can_GetLogStatus(channel) & kCanHwIsInit) != kCanHwIsInit ){
    ...
    CAN_WRITE_SRN_PROTECTED_REG32(CAN_PROTECTED_AREA_SRN,Can_GetSRN_Address(canHwChannel),(vuint32)( (vuint32)kCanMCMcanSRCR_Mask & ( ((vuint32)Can_GetINT_Priority(canHwChannel) | (1u << 10u)) | (Can_GetkCanUsedCore() << 11u) ) )); /* PRQA S 0306,2986,2985 */ /* MD_Can_0306_HWaccess_LL,MD_Can_ConstValue,MD_Can_ConstValue */ /* SBSW_CAN_LL_119 */
  }
#   endif
#  endif
# endif
...
# if defined(C_ENABLE_TRICORE_ERRATUM_AI_H001)
    CanLL_TriCoreErratum_AI_H001(CAN_HW_CHANNEL_CANPARA_FIRST (vuint32)(kCanIR_RF0L | kCanIR_RF0F | kCanIR_RF1L | kCanIR_RF1F));
# else
    Cn->IR = (vuint32)(kCanIR_RF0L | kCanIR_RF0F | kCanIR_RF1L | kCanIR_RF1F);   /* SBSW_CAN_LL_100 */   /* PRQA S 0303 */ /* MD_Can_HwAccess */     /* clear flag(s) */
# endif
  }
...
# if defined(C_ENABLE_TRICORE_ERRATUM_AI_H001)
    CanLL_TriCoreErratum_AI_H001(CAN_HW_CHANNEL_CANPARA_FIRST (vuint32)kCanIR_BO);
# else
    Cn->IR = (kCanIR_BO);   /* SBSW_CAN_LL_100 */    /* clear flag */ /* PRQA S 0303 */ /* MD_Can_HwAccess */
# endif
  }
...
# if defined(C_ENABLE_TRICORE_ERRATUM_AI_H001)
    CanLL_TriCoreErratum_AI_H001(CAN_HW_CHANNEL_CANPARA_FIRST (vuint32)kCanIR_MRAF);
# else
    Cn->IR = (kCanIR_MRAF);   /* SBSW_CAN_LL_100 */    /* clear flag */ /* PRQA S 0303 */ /* MD_Can_HwAccess */
# endif
  }
  else
  {
...
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_StartSilentRequest(CAN_HW_CHANNEL_CANTYPE_ONLY)
{
  ...
  else
  {
    ...
    /* #30 check current state: if already reached then avoid asynchronous all */
    CanLL_ApplCanTimerStart(kCanLoopInit); /* SBSW_CAN_LL_101 */  
    while( ((Cn->CCCR & (vuint32)(kCanCCCR_MON | kCanCCCR_ASM | kCanCCCR_INIT)) != (kCanCCCR_MON | kCanCCCR_ASM)) && (CanLL_ApplCanTimerLoop(kCanLoopInit) !=  CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess */ /* COV_CAN_HW_SPECIFIC */ 
...
\ID SBSW_CAN_LL_109
 ...
 \COUNTERMEASURE \R [CM_CAN_LL_109]
