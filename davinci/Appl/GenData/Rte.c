...
VAR(BswM_ESH_RunRequest, RTE_VAR_NOINIT) Rte_swc_test_Request_ESH_PostRunRequest_0_requestedMode;
/* PRQA L:L1 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Start(void)
{
  ...
  Rte_swc_test_Request_ESH_PostRunRequest_0_requestedMode = 0U;
  ...
  /* activate the tasks */
  (void)ActivateTask(swc_init); /* PRQA S 3417 */ /* MD_Rte_Os */
  (void)ActivateTask(swc_task); /* PRQA S 3417 */ /* MD_Rte_Os */

  /* activate the alarms used for TimingEvents */
  (void)SetRelAlarm(Rte_Al_TE_swc_test_swc_test_10ms, RTE_MSEC_SystemTimer(0) + (TickType)1, RTE_MSEC_SystemTimer(10)); /* PRQA S 3417, 1840 */ /* MD_Rte_Os, MD_Rte_Os */
  (void)SetRelAlarm(Rte_Al_TE_swc_test_swc_test_500ms, RTE_MSEC_SystemTimer(0) + (TickType)1, RTE_MSEC_SystemTimer(500)); /* PRQA S 3417, 1840 */ /* MD_Rte_Os, MD_Rte_Os */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Stop(void)
{
  ...
  /* deactivate alarms */
  (void)CancelAlarm(Rte_Al_TE_swc_test_swc_test_10ms); /* PRQA S 3417 */ /* MD_Rte_Os */
  (void)CancelAlarm(Rte_Al_TE_swc_test_swc_test_500ms); /* PRQA S 3417 */ /* MD_Rte_Os */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_BswM_Request_ESH_PostRunRequest_0_requestedMode(P2VAR(BswM_ESH_RunRequest, AUTOMATIC, RTE_BSWM_APPL_VAR) data) /* PRQA S 3673, 1505, 3206 */ /* MD_Rte_Qac, MD_MSR_Rule8.7, MD_Rte_3206 */
{
  ...
  *(data) = Rte_swc_test_Request_ESH_PostRunRequest_0_requestedMode; /* PRQA S 1339, 2982 */ /* MD_Rte_1339, MD_Rte_2982 */
 ...
 * Schedule: FULL
 *********************************************************************************************************************/
TASK(swc_init) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_Unreachable */
{

  /* call runnable */
  swc_test_Init(); /* PRQA S 2987 */ /* MD_Rte_2987 */
 ...
 * Schedule: FULL
 *********************************************************************************************************************/
TASK(swc_task) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_Unreachable */
{
  EventMaskType ev;

  for(;;)
  {
    (void)WaitEvent(Rte_Ev_Run_swc_test_swc_test_10ms | Rte_Ev_Run_swc_test_swc_test_500ms); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)GetEvent(swc_task, &ev); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)ClearEvent(ev & (Rte_Ev_Run_swc_test_swc_test_10ms | Rte_Ev_Run_swc_test_swc_test_500ms)); /* PRQA S 3417 */ /* MD_Rte_Os */

    if ((ev & Rte_Ev_Run_swc_test_swc_test_10ms) != (EventMaskType)0)
    {
      /* call runnable */
      swc_test_10ms(); /* PRQA S 2987 */ /* MD_Rte_2987 */
    }

    if ((ev & Rte_Ev_Run_swc_test_swc_test_500ms) != (EventMaskType)0)
    {
      /* call runnable */
      swc_test_500ms(); /* PRQA S 2987 */ /* MD_Rte_2987 */
    }
  }
} /* PRQA S 6010, 6030, 6050, 6080 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL, MD_MSR_STMIF */
